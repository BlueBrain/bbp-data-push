...
def create_mesh_resources(
    forge, inputpath: list, config_path, input_hierarchy: list, provenances: list, verbose
) -> list:
    """
    ...
    try:
        ...
        L.error(
            f"KeyError: {error}. The key ['GeneratedDatasetPath']['MeshFile'] is not found "
    ...
    for filepath in inputpath:
        ...
        if os.path.isdir(filepath):
            ...
            try:
                if os.path.samefile(filepath, mesh_path["brain_region_meshes_hybrid"]):
                    ...
                    L.error(
                        f"Error: The '{filepath}' folder do not correspond to one of the "
            ...
            L.error(
                f"Error: '{filepath}' is not a directory. The input dataset need to be a "
        ...
        try:
            ...
            L.error(
                f"ValueError in {'meshpath'} file name. {error}. The mesh file names have "
